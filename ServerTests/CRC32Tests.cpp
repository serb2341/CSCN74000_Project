...
namespace ServerTests {
	...
	public:
		...
		TEST_METHOD(KnownValue_123456789) {
		...
		TEST_METHOD(SameInput_SameOutput) {
		...
		TEST_METHOD(DifferentInput_DifferentOutput) {
		...
		TEST_METHOD(AllZeroBytes_NonZeroCRC) {
		...
		TEST_METHOD(LargeInput_DoesNotCrash) {
		...
		TEST_METHOD(CRC_ChangesWhenByteFlipped) {
