...
namespace ServerTests {
    ...
    public:
        ...
        TEST_METHOD(SVR_STR_TEST_001_PacketHeader_SizeIs16Bytes) {
            Assert::AreEqual(static_cast<size_t>(16U), sizeof(ServerCommunication::PacketHeader),
                L"PacketHeader must be exactly 16 bytes with #pragma pack(1). "
                L"If this fails, compiler padding is breaking the wire format.");
        };

        TEST_METHOD(SVR_STR_TEST_002_PacketHeader_FlightID_Offset0) {
            // FlightID must start at byte 0 of the struct.
            ServerCommunication::PacketHeader h{};
        ...
        TEST_METHOD(SVR_STR_TEST_003_PacketHeader_MessageType_Offset4) {
            ServerCommunication::PacketHeader h{};
        ...
        TEST_METHOD(SVR_STR_TEST_004_PacketHeader_TimeStamp_Offset12) {
            ServerCommunication::PacketHeader h{};
        ...
        TEST_METHOD(SVR_STR_TEST_005_PacketHeader_Length_Offset8) {
            ServerCommunication::PacketHeader h{};
        ...
        TEST_METHOD(SVR_STR_TEST_006_ChallengePacket_SizeIs12Bytes) {
            Assert::AreEqual(static_cast<size_t>(12U), sizeof(ServerHandshake::ChallengePacket), L"ChallengePacket must be exactly 12 bytes.");
        };

        TEST_METHOD(SVR_STR_TEST_007_ResponsePacket_SizeIs12Bytes) {
            Assert::AreEqual(static_cast<size_t>(12U), sizeof(ServerHandshake::ResponsePacket), L"ResponsePacket must be exactly 12 bytes.");
        };

        TEST_METHOD(SVR_STR_TEST_008_ChallengePacket_Type_Offset0) {
            ServerHandshake::ChallengePacket p{};
        ...
        TEST_METHOD(SVR_STR_TEST_009_ChallengePacket_CRC32_Offset8) {
            ServerHandshake::ChallengePacket p{};
        ...
        TEST_METHOD(SVR_STR_TEST_010_ResponsePacket_CRC32_Offset8) {
            ServerHandshake::ResponsePacket p{};
